...
export default function searchFunc() {
  ...
  const client = algoliasearch('1RW3H65RW2', '03159da5ac82d44f1828f6ddd0e0598d')
  const index = client.initIndex('anolis')
  // index.setSettings({
  //   hitsPerPage: 10
  // })
  ...
  const searchFunc = () => {
    ...
    history.pushState(null, `${query} · Anolis`, `/search/?${qs.stringify(searchParam)}`)
